...
func init() {
	...
	addCmd.Flags().StringVarP(&parentName, "parent", "p", "", "variable name of parent command for this command")
...
func validateCmdName(source string) string {
	...
	if output == "" {
		return strings.Title(source) // source is initially valid name.
	}
